    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <a href="index.html" class="flex ml-2 md:mr-24">
          ...
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Saving App</span>
        </a>
          ...
          <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown">
            ...
            <div>
              ...
              <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                <div class="flex-shrink-0">
                  <img clafss="rounded-full w-11 h-11" src="images/users/robert-brown.png" alt="Robert image">
          ...
          <div class="flex items-center ml-3">
            <div>
              <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                ...
                <img class="w-8 h-8 rounded-full" src="../flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo">
              </button>
            </div>
