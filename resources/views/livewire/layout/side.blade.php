<ul class="pb-2 space-y-2">
          ...
          <li>
            <a href="{{ route('admins')}}" wire:navigate class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
                <span class="ml-3" sidebar-toggle-item>Admins</span>
            </a>
          </li>
          <li>
            ...
            <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
              <li>
                <a href="{{route('members')}}" wire:navigate class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Create New Member</a>
              </li>
              <li>
          ...
          <li>
            ...
            <ul id="dropdown-crud" class="space-y-2 py-2 hidden ">
              ...
              <li>
                <a href="{{ route('users')}}" wire:navigate  class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Users</a>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            ...
            <ul id="dropdown-playground" class="space-y-2 py-2 hidden ">
              <li>
                <a href="playground/stacked/index.html" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Stacked</a>
              </li>
              <li>
                <a href="playground/sidebar/index.html" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Sidebar</a>
              </li>
            </ul>
          </li>
        </ul>