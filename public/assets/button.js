...
!(function () {
    ...
    var e = window.document,
            ...
            return function (o, t, r) {
                ...
                return (
                    null != r &&
                        u(r, function (o) {
                            a.appendChild(
                                "string" == typeof o ? e.createTextNode(o) : o
                            );
                        }),
                    a
                );
            ...
            return (
                u(e.split(o), function (e) {
                    if ("" !== e) {
                        var o = e.split(t);
                        a[r(o[0])] =
                            null != o[1] ? r(o.slice(1).join(t)) : void 0;
                    }
                }),
                a
            );
        ...
        _ = function (e) {
            return (
                (L > 1 ? t.ceil((t.round(e * L) / L) * 2) / 2 : t.ceil(e)) || 0
            );
        },
        G = function (e, o) {
                ...
                if (
                    ...
                    var c = function () {
                        ...
                        try {
                            ...
                            return void e.body.appendChild(
